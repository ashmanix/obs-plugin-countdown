...
// void CountdownDockWidget::HandleWebsocketButtonPressRequest(WebsocketRequestType requestType, const char *timerId)
// {
// 	obs_log(LOG_INFO, "We ARE HERE");
...
// 	AshmanixTimer *timer = AttemptToGetTimerWidgetById(this, timerId);
